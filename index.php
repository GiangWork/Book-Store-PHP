      ...
      <div class="container-fluid">
        ...
        if(!isset($_SESSION['user']))
          ...
          {   echo' <li> <a href="#" class="btn btn-lg"> Xin chào ' .$_SESSION['user']. '</a></li>
                    ...
                    <li> <a href="addBook.php" class="btn btn-lg"> Thêm sách </a> </li>;
                    <li> <a href="addBook.php" class="btn btn-lg"> Đơn hàng </a> </li>;
...
?>
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  ...
                  <ul>
                      <li> <a href="Product.php?value=entrance%20exam"> Sách luyện thi </a> </li>
                      <li> <a href="Product.php?value=Literature%20and%20Fiction"> Văn học & Tiểu thuyết </a> </li>
                      <li> <a href="Product.php?value=Academic%20and%20Professional"> Học thuật </a> </li>
                      <li> <a href="Product.php?value=Biographies%20and%20Auto%20Biographies"> Tiểu sử & Tự truyện </a> </li>
                      <li> <a href="Product.php?value=Children%20and%20Teens"> Thiếu nhi & Trẻ em </a> </li>
                      <li> <a href="Product.php?value=Regional%20Books"> Sách khu vực </a> </li>
                      <li> <a href="Product.php?value=Business%20and%20Management"> Quản trị kinh doanh </a> </li>
  ...
  <div class="container-fluid" id="author">
      <h3 style="color:#D67B22;"> Các tác giả phổ biến </h3>
      <div class="row">
...
<div class="container">
  ...
  <button type="button" id="query_button" class="btn btn-lg" data-toggle="modal" data-target="#query">Đặt câu hỏi tại đây</button>
  <!-- Modal -->
  <div class="modal fade" id="query" role="dialog">
    <div class="modal-dialog">  
          <div class="modal-header text-center">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Hãy đặt câu hỏi cho chúng tôi</h4>
          </div>
          <div class="modal-body">           
