        ...
        if(isset($_GET['place']))
                 ...
                 ?>
                    <script type="text/javascript">
                         alert("Đặt hàng thành công! Đơn hàng sẽ nhanh chóng được giao.");
                    </script>
                 <?php                  
                  }
...
echo '<div class="container-fluid" id="cart">
      <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:#D67B22;text-transform:uppercase;"> GIỎ HÀNG </h2>
           </div>
        </div>';
	if(isset($_SESSION['user']))
	    {   
                    ...
                    echo '<div class="container">
                     ...
                     echo '<div class="row">
                             <div class="col-xs-8 col-xs-offset-2  col-sm-4 col-sm-offset-2 col-md-4 col-md-offset-3 col-lg-4 col-lg-offset-3">
                                  <a href="index.php" class="btn btn-lg" style="background:#D67B22;color:white;font-weight:800;">Tiếp tục mua hàng</a>
                             </div>
                        ...
                        echo ' 
                         <div class="row">
                            <div class="col-xs-9 col-xs-offset-3 col-sm-4 col-sm-offset-5 col-md-4 col-md-offset-5">
                                 <span class="text-center" style="color:#D67B22;font-weight:bold;">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Giỏ hàng trống</span>
                             </div>
                         </div>
                         <div class="row">
