          ...
          <ul class="nav navbar-nav navbar-right">
              <?php
                  if(isset($_SESSION['user']))
                    {
                      echo'
                    <li><a href="cart.php" class="btn btn-lg"><span class="glyphicon glyphicon-shopping-cart"> Giỏ hàng </span></a></li>
                    <li><a href="destroy.php" class="btn btn-lg"> <span class="glyphicon glyphicon-log-out"> Đăng xuất </span></a></li>
                         ';
                    }
               ?>
          </ul>
        ...
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" name="keyword" class="form-control" placeholder="Nhập tên sách, Tác giả hoặc Thể loại..." style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
   </div>
  ...
  <div class="container-fluid" id="books">
    <div class="row">
      <div class="col-sm-10 col-md-6">
                          <div class="tag">Giảm '.$row["Discount"].'%</div>
...
echo'                           <br><br><br>
     ...
     ';
echo '
          <div class="container-fluid" idd="escription">
    <div class="row">
   ...
   SỐ LƯỢNG CÒN   '.$row["Available"].' <hr> 
   NHÀ XUẤT BẢN   '.$row["Publisher"].' <hr> 
   TÁI BẢN SỐ     '.$row["Edition"].' <hr>
   NGÔN NGỮ       '.$row["Language"].' <hr>
   SỐ TRANG       '.$row["page"].' <hr>
   CÂN NẶNG       '.$row["weight"].' grams  <hr>
                        </pre>
    </div>
  </div>
';
...
<div class="container-fluid" id="service">
      <div class="row">
          <div class="col-sm-6 col-md-3 text-center">
               ...
               24/7 <br>
               Chăm sóc khách hành 24/7
          </div>
          <div class="col-sm-6 col-md-3 text-center">
               <span class="glyphicon glyphicon-ok"></span> <br>
               Lòng tin <br>
               Lòng tin của khách hàng là ưu tiên hàng đầu.
          </div>
          <div class="col-sm-6 col-md-3 text-center">
               <span class="glyphicon glyphicon-check"></span> <br>
               Đảm bảo <br>
               Đảm bảo hoàn trả 100% giá tiền khi phát hiện sách giả.
          </div>
          <div class="col-sm-6 col-md-3 text-center">
